...
function DomainRoute() {
  ...
  const rawDomainId = params.domainId;
  ...
  // Fetch domain data - domains use the topics endpoint with full domain URL
  ...
  return (
    <EntityDetailLayout
      ...
      <IncomingRelationships entityId={fullDomainId} entityType="topics" />
      <OutgoingRelationships entityId={fullDomainId} entityType="topics" />
    </EntityDetailLayout>
  );
}
