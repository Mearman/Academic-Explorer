...
function SourceRoute() {
  ...
  if (isLoading) {
    content = (
      <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 flex items-center justify-center p-8">
        <div className="bg-white rounded-2xl shadow-2xl p-12 max-w-md w-full text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-3">Loading Source...</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 flex items-center justify-center p-8">
        <div className="bg-white rounded-2xl shadow-2xl p-12 max-w-2xl w-full">
          <div className="text-center mb-6">
            ...
            <h2 className="text-3xl font-bold text-red-600 mb-2">Error Loading Source</h2>
          </div>
          <div className="space-y-3 text-left">
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-sm text-gray-600 font-semibold mb-1">Source ID:</p>
              <p className="text-gray-800 font-mono break-all">{sourceId}</p>
            </div>
    ...
    content = (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-amber-50 to-orange-50 p-8">
        <div className="max-w-7xl mx-auto">
          {/* Header Section */}
          <div className="bg-gradient-to-br from-white to-amber-50 rounded-2xl shadow-2xl p-8 mb-8 border border-amber-100">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div className="flex-1">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2 text-sm">
                    <span className="font-semibold text-gray-700 min-w-[100px]">Source ID:</span>
              ...
              <div className="flex-shrink-0">
                <button
                  ...
                  className="group relative px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl hover:from-amber-600 hover:to-orange-700 transition-all duration-200 transform hover:scale-105"
                >
