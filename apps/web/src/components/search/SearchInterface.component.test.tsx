...
describe("SearchInterface", () => {
	...
	it("should handle debounced search for valid queries", async () => {
		...
		const { debouncedSearch, isValidSearchQuery } = await import("@academic-explorer/utils");
	...
	it("should normalize search query on search", async () => {
		// Import the mocked functions to access them
		const { normalizeSearchQuery, isValidSearchQuery } = await import("@academic-explorer/utils");
