...
const AppActivitySection: React.FC = () => {
  ...
  const copyAllEvents = () => {
    ...
    logger.debug(
      "ui",
      "Copied all events to clipboard",
          ...
          >
            ...
            {event.metadata && Object.keys(event.metadata).length > 0 && (
              <div>
                ...
                <Code block>{JSON.stringify(event.metadata, null, 2)}</Code>
              </div>
            )}
          </Stack>
        </Collapse>
        ...
        <Stack gap="xs">
          ...
          <Group justify="space-between">
            <div>
              ...
              <Text fw={500} size="sm" c="blue">
                {activityStats.userInteractions}
              </Text>
            </div>
            <div>
              <Text size="xs" c={colors.text.secondary}>
              ...
              <Text fw={500} size="sm">
                {activityStats.navigationEvents}
              </Text>
            </div>
            <div>
              <Text size="xs" c={colors.text.secondary}>
              ...
              <Text fw={500} size="sm">
                {activityStats.componentLifecycleEvents}
              </Text>
            </div>
            <div>
              <Text size="xs" c={colors.text.secondary}>
          ...
          <Group justify="space-between" align="center">
            {activityStats.memoryUsage && (
              <Group gap="xs">
                ...
                <div>
                  ...
                  <Text fw={500} size="sm">
                    {formatMemory(activityStats.memoryUsage)}
                  </Text>
                </div>
              </Group>
            )}
                ...
                <div>
                  ...
                  <Group gap="xs" align="center">
                    <RingProgress
                      ...
                      sections={[
                        {
                          value: activityStats.performanceScore,
                          color: getPerformanceColor(),
                        },
                      ]}
                    />
                    <Text fw={500} size="sm">
                      {Math.round(activityStats.performanceScore)}
                    </Text>
                  </Group>
                </div>
              </Group>
            ...
            <div>
              ...
              <Text fw={500} size="sm">
                {activityStats.averageEventFrequency.toFixed(1)}/min
              </Text>
            </div>
          </Group>
        </Stack>
          ...
          <Stack gap="xs">
            ...
            <Group grow>
              ...
              <Select
                ...
                onChange={(value) => {
                  setTimeRange(value ? parseInt(value, 10) : 30);
                }}
                size="sm"
              />
            </Group>
          ...
          {filteredEvents.length === 0 ? (
            ...
            <>
              ...
              {renderEventGroup({
                ...
                events: eventGroups["interactions"],
                color: "blue",
              })}
              ...
              {renderEventGroup({
                title: "Performance",
                events: eventGroups["performance"],
                color: "yellow",
              })}
