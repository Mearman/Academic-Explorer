...
export const EdgeRepositorySection: React.FC = () => {
	...
	const edgeTypeFilter = repositoryStore.edgeTypeFilter;
	const selectedRepositoryEdges = repositoryStore.selectedRepositoryEdges;
	const setEdgeTypeFilter = repositoryStore.setEdgeTypeFilter;
	const selectRepositoryEdge = repositoryStore.selectRepositoryEdge;
	const selectAllEdges = repositoryStore.selectAllEdges;
	...
	const getFilteredEdges = repositoryStore.getFilteredEdges;
	const getSelectedEdges = repositoryStore.getSelectedEdges;
	const recomputeFilteredEdges = repositoryStore.recomputeFilteredEdges;
