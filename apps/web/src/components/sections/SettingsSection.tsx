...
import { clearAllCacheLayers } from "@academic-explorer/shared-utils/cache";
import { clearAppMetadata } from "@academic-explorer/shared-utils/cache";
	...
	return (
		<Stack gap="md">
			...
			<Stack gap="sm">
				...
				{!isEditingEmail ? (
					<Group gap="sm">
						<Text size="sm" c={hasStoredEmail ? undefined : "dimmed"}>
