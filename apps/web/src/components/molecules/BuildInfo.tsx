...
import { getBuildInfo, formatBuildTimestamp, getCommitUrl, getReleaseUrl, getRelativeBuildTime } from "@academic-explorer/shared-utils";
	...
	return (
		<div style={{
			...
			<div style={{
				...
				<a
					href={getReleaseUrl(buildInfo.repositoryUrl, buildInfo.version)}
					target="_blank"
			...
			<div style={{
				...
				<a
					href={getCommitUrl(buildInfo.repositoryUrl, buildInfo.commitHash)}
					target="_blank"
					rel="noopener noreferrer"
					style={{
