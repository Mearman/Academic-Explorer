...
export function EntityBrowser({ className }: EntityBrowserProps) {
  ...
  const effectiveLimit = shouldLoadMore
    ? Math.max(pageSize * 10, 1000)
    : pageSize; // Load more data when virtualizing
        ...
        <Paper p="lg" withBorder>
          <Group justify="space-between" mb="md">
            <div>
              ...
              <Text size="sm" c="dimmed">
                Explore your cached OpenAlex entities
              </Text>
            </div>
          ...
          {state.stats && (
            <Group gap="xl">
              ...
              <div>
                <Text size="lg" fw={600}>
                  {Object.keys(state.stats.entitiesByType).length}
                </Text>
                <Text size="xs" c="dimmed">
                  Entity Types
                </Text>
        ...
        <Paper p="md" withBorder>
          ...
          {state.hasMore && (
            <Group justify="center" mt="md">
              <Text size="sm" c="dimmed">
                Showing {state.entities.length} of {state.totalMatching}{" "}
                entities
              </Text>
            </Group>
          )}
