...
test.describe('Debug Homepage', () => {
  test('should log page content and check for errors', async ({ page }) => {
    ...
    const academicExplorerText = await page.locator('text=Academic Explorer').count()
    ...
    const reactContent = await page.locator('[data-reactroot], [data-react-helmet]').count()
