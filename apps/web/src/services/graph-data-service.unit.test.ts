...
describe("GraphDataService", () => {
	...
	beforeEach(() => {
		...
		vi.mocked(EntityDetectionService.detectEntity).mockImplementation((id: string) => {
			if (id === "invalid-id") {
				return null;
			}
		...
		vi.mocked(cachedOpenAlex.client.getEntity).mockImplementation((id: string) => {
	...
	describe("loadEntityGraph", () => {
		it("should load entity graph successfully", async () => {
			...
			expect(EntityDetectionService.detectEntity).toHaveBeenCalledWith("W123456789");
	...
	describe("loadEntityIntoGraph", () => {
		...
		it("should load new entity if not exists", async () => {
			...
			expect(EntityDetectionService.detectEntity).toHaveBeenCalledWith("A123456789");
	...
	describe("searchAndVisualize", () => {
		...
		it("should handle search errors gracefully", async () => {
			...
			vi.mocked(cachedOpenAlex.client.works.getWorks).mockRejectedValueOnce(searchError);
