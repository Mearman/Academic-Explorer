...
import { cachedOpenAlex } from "@academic-explorer/openalex-client";
import { EntityDetector } from "@academic-explorer/graph";
import { detectEntityType } from "@academic-explorer/shared-utils";
import { EntityFactory, type ExpansionOptions } from "@academic-explorer/shared-utils";
import { useGraphStore } from "@/stores/graph-store";
import { useRepositoryStore } from "@/stores/repository-store";
import { useExpansionSettingsStore } from "@/stores/expansion-settings-store";
import { logError, logger } from "@academic-explorer/shared-utils/logger";
...
import { safeSlice } from "@academic-explorer/openalex-client";
import { isEntityType } from "@academic-explorer/shared-utils";
import { isWork, isAuthor, isSource, isInstitution } from "@academic-explorer/openalex-client";
import {
	...
	setNodeExpanded,
	isNodeExpanded
} from "@academic-explorer/shared-utils/cache";
import type {
	GraphNode,
	GraphEdge,
	EntityType,
