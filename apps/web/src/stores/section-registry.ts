...
const SearchSection = React.lazy(() =>
  import("@/components/sections").then((m) => ({ default: m.SearchSection })),
);
const EntityFiltersSection = React.lazy(() =>
...
const EdgeFiltersSection = React.lazy(() =>
  import("@/components/sections").then((m) => ({
...
const GraphStatsSection = React.lazy(() =>
  import("@/components/sections").then((m) => ({
    default: m.GraphStatsSection,
  })),
);
const SettingsSection = React.lazy(() =>
  import("@/components/sections").then((m) => ({ default: m.SettingsSection })),
);
const NetworkActivitySection = React.lazy(() =>
  import("@/components/sections").then((m) => ({
    default: m.NetworkActivitySection,
  })),
);
const AppActivitySection = React.lazy(() =>
  import("@/components/sections").then((m) => ({
    default: m.AppActivitySection,
  })),
);
...
const AllNodesSection = React.lazy(() =>
  import("@/components/sections").then((m) => ({ default: m.AllNodesSection })),
);
const AllEdgesSection = React.lazy(() =>
  import("@/components/sections").then((m) => ({ default: m.AllEdgesSection })),
);
const CustomForcesSection = React.lazy(() =>
  import("@/components/sections").then((m) => ({
    default: m.CustomForcesSection,
  })),
);

// Constants for repeated strings
const GRAPH_CONTROL_CATEGORY = "graph-control";
 ...
 */
export const getDefaultSectionPlacements = (): Record<
  string,
  "left" | "right"
> => {
 ...
 */
export const getSectionsSorted = (
