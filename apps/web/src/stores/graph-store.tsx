...
const getInitialState = (): GraphState => ({
  ...
  entityTypeStats: {
    ...
    domains: { total: 0, visible: 0 },
    fields: { total: 0, visible: 0 },
    subfields: { total: 0, visible: 0 },
    total: 0,
    visible: 0,
  },
  edgeTypeStats: {
    ...
    [RelationType.FIELD_PART_OF_DOMAIN]: { total: 0, visible: 0 },
    [RelationType.TOPIC_PART_OF_SUBFIELD]: { total: 0, visible: 0 },
    [RelationType.TOPIC_SIBLING]: { total: 0, visible: 0 },
    [RelationType.INSTITUTION_ASSOCIATED]: { total: 0, visible: 0 },
    [RelationType.INSTITUTION_HAS_REPOSITORY]: { total: 0, visible: 0 },
    [RelationType.CONCEPT]: { total: 0, visible: 0 },
    [RelationType.HAS_ROLE]: { total: 0, visible: 0 },
    total: 0,
    visible: 0,
  },
  lastSearchStats: {},
