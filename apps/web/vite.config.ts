...
export default defineConfig(({ mode }) => ({
  resolve: {
    alias: {
      ...
      '@academic-explorer/utils': path.resolve(workspaceRoot, 'packages/utils/src/index.ts'),
      '@academic-explorer/utils/': path.resolve(workspaceRoot, 'packages/utils/src'),
      '@academic-explorer/client': path.resolve(workspaceRoot, 'packages/client/src/index.ts'),
      '@academic-explorer/client/': path.resolve(workspaceRoot, 'packages/client/src'),
      '@academic-explorer/ui': path.resolve(workspaceRoot, 'packages/ui/src/index.ts'),
      '@academic-explorer/ui/': path.resolve(workspaceRoot, 'packages/ui/src'),
      '@academic-explorer/graph': path.resolve(workspaceRoot, 'packages/graph/src/index.ts'),
      '@academic-explorer/graph/': path.resolve(workspaceRoot, 'packages/graph/src'),
      '@academic-explorer/simulation': path.resolve(workspaceRoot, 'packages/simulation/src/index.ts'),
