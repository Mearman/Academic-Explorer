...
const config = [
  ...
  ...reactConfig,
  {
    ...
    rules: {
      ...
      "react/no-unknown-property": "off", // Allow Three.js/React Three Fiber properties

      // Disable overly strict rules for frontend app code
      "no-type-assertions-plugin/no-type-assertions": "off", // Allow type assertions in React components
      "@typescript-eslint/prefer-nullish-coalescing": "off", // Allow logical OR in JSX expressions
      "@typescript-eslint/no-floating-promises": "off", // Allow unhandled promises in React components
