...
This package follows independent versioning within the monorepo.
...
- **readme:** add README files for monorepo structure ([ec93b72b](https://github.com/Mearman/Academic-Explorer/commit/ec93b72b))

### Other

- **config:** remove emojis from conventional commit titles and changelogs ([4c67add9](https://github.com/Mearman/Academic-Explorer/commit/4c67add9))
...
- **test:** resolve flaky network pooling test for 840/840 perfection ([d738c931](https://github.com/Mearman/Academic-Explorer/commit/d738c931))
...
- **refactor:** clean up remaining unused files and fix imports ([f4a9f64e](https://github.com/Mearman/Academic-Explorer/commit/f4a9f64e))
...
- **graph:** modernize documentation for active development focus ([aa7231f2](https://github.com/Mearman/Academic-Explorer/commit/aa7231f2))

### Other

- **refactor(graph):** modernize provider and service architecture ([68897945](https://github.com/Mearman/Academic-Explorer/commit/68897945))
- **refactor(graph):** modernize test data to proper OpenAlex ID format ([850d27a5](https://github.com/Mearman/Academic-Explorer/commit/850d27a5))
- **refactor(graph):** modernize package configuration for active development ([8354758b](https://github.com/Mearman/Academic-Explorer/commit/8354758b))
- **refactor(graph):** remove legacy EntityDetector class and backwards compatibility ([a9eede08](https://github.com/Mearman/Academic-Explorer/commit/a9eede08))
- **config(graph):** enhance package configuration for comprehensive testing ([219b86e7](https://github.com/Mearman/Academic-Explorer/commit/219b86e7))
- **test(graph):** add comprehensive test infrastructure and examples ([8b445c03](https://github.com/Mearman/Academic-Explorer/commit/8b445c03))
- **test(graph):** add EntityResolver comprehensive test suite ([202c5a02](https://github.com/Mearman/Academic-Explorer/commit/202c5a02))
- **test(graph):** add comprehensive provider test suites ([c3e0075f](https://github.com/Mearman/Academic-Explorer/commit/c3e0075f))
- **test(graph):** add comprehensive EntityDetectionService unit tests ([1552bc83](https://github.com/Mearman/Academic-Explorer/commit/1552bc83))
...
Initial release of @academic-explorer/graph package within the monorepo structure.