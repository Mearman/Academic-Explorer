      ...
      const testCases = [
        {
          ...
          expectedLabel: "Machine Learning Applications in Academic Research",
        },
        {
          id: "A5017898742",
          type: "authors" as EntityType,
          expectedLabel: "Dr. Jane Smith",
        },
        {
          id: "S4210184550",
          type: "sources" as EntityType,
          expectedLabel: "Nature Machine Intelligence",
        },
        {
          id: "I123456789",
          type: "institutions" as EntityType,
          expectedLabel: "University of Example",
        },
      ];
    ...
    it("demonstrates basic entity searching", async () => {
      ...
      results.forEach((result) => {
        expect(result).toMatchObject({
          ...
          entityType: expect.stringMatching(
            /^(authors|works|sources|institutions)$/,
          ),
