...
describe("Test Utilities Examples", () => {
  ...
  describe("Test Pattern Usage", () => {
    it(
      "uses unit test pattern",
      testPatterns.unit(async () => {
    ...
    it(
      "uses provider test pattern",
      testPatterns.provider(async () => {
  ...
  describe("Assertion Utilities", () => {
    it("validates with custom assertions", async () => {
      const nodes = [createNodeFixture("works"), createNodeFixture("authors")];
