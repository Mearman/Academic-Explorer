...
import type { EntityType, RelationType } from "@academic-explorer/types"

// Re-export RelationType for backward compatibility
export { RelationType } from "@academic-explorer/types"
