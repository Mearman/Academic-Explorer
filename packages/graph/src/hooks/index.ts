...
export function useEventSubscriptions(
  ...
  throw new Error("useEventSubscriptions hook not available in graph package - use from application layer");
}
...
export function useAnimatedLayout(): {
  ...
  throw new Error("useAnimatedLayout hook not available in graph package - use from application layer");
}

// Hook for unified task system (stub)
export function useUnifiedTaskSystem(): unknown {
  throw new Error("useUnifiedTaskSystem hook not available in graph package - use from application layer");
}