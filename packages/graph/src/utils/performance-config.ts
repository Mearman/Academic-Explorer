...
function hasRequestAnimationFrame(
	context: unknown
): context is { requestAnimationFrame: typeof requestAnimationFrame } {
...
export function detectDeviceCapabilities(): DeviceCapabilities {
	...
	const memory =
		hasDeviceMemory(navigator) && navigator.deviceMemory
	...
	const supportsRequestAnimationFrame =
		typeof requestAnimationFrame !== "undefined" && hasRequestAnimationFrame(self)
...
export function getOptimalPerformanceConfig(
	...
	logger.debug("performance", "Calculating optimal performance config", {
		graphMetrics,
	...
	logger.debug("performance", "Optimal performance config calculated", {
