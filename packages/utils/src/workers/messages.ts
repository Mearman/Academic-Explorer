...
export type ForceSimulationStartMessage = z.infer<
  typeof forceSimulationStartMessageSchema
>;
export type ForceSimulationControlMessage = z.infer<
  typeof forceSimulationControlMessageSchema
>;
export type ForceSimulationReheatMessage = z.infer<
...
export type WorkerProgressResponse = z.infer<
  typeof workerProgressResponseSchema
>;
...
// Runtime validators
export const validateGraphWorkerRequest = (
  data: unknown,
): data is GraphWorkerRequest => {
  return graphWorkerRequestSchema.safeParse(data).success;
};

export const validateGraphWorkerResponse = (
  data: unknown,
): data is GraphWorkerResponse => {
...
export const isExecuteTaskMessage = (
  data: unknown,
): data is ExecuteTaskMessage => {
  return executeTaskMessageSchema.safeParse(data).success;
};

export const isWorkerProgressResponse = (
  data: unknown,
): data is WorkerProgressResponse => {
  return workerProgressResponseSchema.safeParse(data).success;
};

export const isWorkerSuccessResponse = (
  data: unknown,
): data is WorkerSuccessResponse => {
  return workerSuccessResponseSchema.safeParse(data).success;
};

export const isWorkerErrorResponse = (
  data: unknown,
): data is WorkerErrorResponse => {
  return workerErrorResponseSchema.safeParse(data).success;
};

export const isWorkerReadyResponse = (
  data: unknown,
): data is WorkerReadyResponse => {
