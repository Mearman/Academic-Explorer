...
describe('Leiden Community Detection', () => {
  ...
  describe('User Story 5 - Scenario 3: Performance < 35s', () => {
    it('should complete in under 35 seconds for 1000-paper network', { timeout: 40000 }, () => {
      ...
      // Then: Algorithm completes in under 35 seconds
      expect(executionTime).toBeLessThan(35000); // 35 seconds in milliseconds
    ...
    it('should maintain quality and connectivity at scale', { timeout: 40000 }, () => {
