...
describe('dfs (Performance)', () => {
  it('should traverse 1000-node graph in <100ms (SC-001)', () => {
    ...
    console.log(`DFS 1000 nodes: ${duration.toFixed(2)}ms`);
  });
  ...
  it('should handle dense graph efficiently', () => {
    ...
    console.log(`DFS dense graph (${nodeCount} nodes, ${edgeId} edges): ${duration.toFixed(2)}ms`);
  });
});
