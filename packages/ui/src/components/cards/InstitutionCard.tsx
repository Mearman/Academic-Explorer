import type { InstitutionEntity } from "@academic-explorer/types"
import { isInstitution } from "@academic-explorer/types"
...
export const InstitutionCard: React.FC<InstitutionCardProps> = ({
	...
	const location = [validatedInstitution.geo?.city, validatedInstitution.geo?.country]
		.filter(Boolean)
		.join(", ")
