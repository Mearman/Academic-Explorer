...
export type BaseEntityWithTopicsFilters = z.infer<typeof BaseEntityWithTopicsFiltersSchema>
...
export const InstitutionsFiltersSchema = BaseEntityWithTopicsFiltersSchema.extend({
