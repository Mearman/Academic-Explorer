 ...
 */
export const FunderAutocompleteOptionsSchema = BaseAutocompleteOptionsSchema.extend({})

export type FunderAutocompleteOptions = z.infer<typeof FunderAutocompleteOptionsSchema>
