 ...
 */
export const PublisherAutocompleteOptionsSchema = BaseAutocompleteOptionsSchema.extend({})

export type PublisherAutocompleteOptions = z.infer<typeof PublisherAutocompleteOptionsSchema>
