  ...
  describe("get", () => {
    it("should fetch a single topic by ID", async () => {
      const mockTopic: Partial<Topic> = {
        ...
        ids: { openalex: "T10138" },
        subfield: { id: "T101", display_name: "Computer Science" },
        field: { id: "T10", display_name: "Computer Science" },
        domain: { id: "T1", display_name: "Natural Sciences" },
        counts_by_year: [],
        works_api_url: "https://api.openalex.org/works?filter=topics.id:T10138",
      ...
      const mockBatch: Topic[] = [
        {
          ...
          domain: { id: "T1", display_name: "Natural Sciences" },
          counts_by_year: [],
          works_api_url: "https://api.openalex.org/works?filter=topics.id:T1",
          updated_date: "2023-01-01",
          created_date: "2023-01-01",
        },
      ];
