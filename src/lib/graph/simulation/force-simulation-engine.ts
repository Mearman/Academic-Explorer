...
export class ForceSimulationEngine {
  ...
  private applyPendingUpdates(): boolean {
    console.log("🔗 ENGINE: applyPendingUpdates - Start", {
    ...
    if (!this.currentSimulation || this.pendingUpdates.length === 0) {
      console.log("🔗 ENGINE: applyPendingUpdates - Early return", {
        hasSimulation: !!this.currentSimulation,
        pendingUpdatesCount: this.pendingUpdates.length
      });
      return false;
    ...
    for (const update of this.pendingUpdates) {
      if (update.type === "links" && update.links) {
        console.log("🔗 ENGINE: applyPendingUpdates - Processing links update", {
          linksCount: update.links.length,
          alpha: update.alpha
        });
        console.log("🔗 ENGINE: applyPendingUpdates - About to apply links and restart", {
        ...
        console.log("🔗 ENGINE: applyPendingUpdates - Links applied and simulation restarted", {
        ...
        console.log("🔗 ENGINE: applyPendingUpdates - Processing nodes update");
    ...
    this.pendingUpdates = [];
    console.log("🔗 ENGINE: applyPendingUpdates - Complete", { applied });
  ...
  private applyLinksImmediately(
    ...
    if (!this.currentSimulation) {
      console.log("🔗 ENGINE: applyLinksImmediately - NO CURRENT SIMULATION");
      return;
    }

    console.log("🔗 ENGINE: applyLinksImmediately - Starting link application", {
    ...
    console.log("🔗 ENGINE: applyLinksImmediately - After mapping", {
    ...
    this.currentSimulation.force("link", linkForce);
    console.log("🔗 ENGINE: applyLinksImmediately - Link force applied to simulation", {
