...
import { IconDatabase, IconTrash, IconDownload, IconUpload, IconRefresh } from "@tabler/icons-react";
import { Button, NumberInput, Switch, Badge, Progress, Group, Text, Modal } from "@mantine/core";
		...
		<div className={className} style={{ padding: "16px" }}>
				...
				<div style={{ marginTop: "8px" }}>
					<div style={{
						...
						<div style={{
							...
							<Text size="sm" c="dimmed">Cache Entries</Text>
							<Badge size="sm" variant="light">{cacheStats.entries.toLocaleString()}</Badge>
						</div>
						<div style={{
							display: "flex",
							justifyContent: "space-between",
							...
							<Badge size="sm" variant="light" color="green">{cacheStats.hitRate}%</Badge>
						</div>
						<div style={{
							display: "flex",
							justifyContent: "space-between",
						...
						<div>
							<div style={{
								...
								<Text size="xs" c="dimmed">Storage Usage</Text>
			...
			>
				<div style={{ marginTop: "12px" }}>
					<div style={{
						...
						<div>
							<Text size="sm" fw={500}>Show Cached Nodes</Text>
							<Text size="xs" c="dimmed">
					...
					<div style={{
						...
						<div style={{ flex: 1, marginRight: "16px" }}>
							<Text size="sm" fw={500}>Traversal Depth</Text>
							<Text size="xs" c="dimmed">
				...
				<div style={{ marginTop: "12px" }}>
					<div style={{
						...
						<div style={{
							...
							<Text size="sm" c="dimmed">Current Graph</Text>
							<div>
			...
			>
				<Text size="sm" style={{ marginBottom: "16px" }}>
					Are you sure you want to clear the current graph? This will remove all {totalNodeCount} nodes and {totalEdgeCount} edges.
				</Text>
