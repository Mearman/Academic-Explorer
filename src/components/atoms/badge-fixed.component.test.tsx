...
describe('Badge Component (Fixed)', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render with default props', () => {
      render(<Badge data-testid="default-badge">Test Badge</Badge>);
    ...
    it('should forward ref correctly', () => {
      ...
      render(<Badge ref={ref} data-testid="ref-badge">Test</Badge>);
  ...
  describe('Error Handling', () => {
    it('should handle undefined onRemove gracefully', () => {
      expect(() => {
        render(<Badge removable onRemove={undefined} data-testid="undefined-remove">Test</Badge>);
      }).not.toThrow();
    ...
    it('should handle invalid variant gracefully', () => {
      expect(() => {
        render(<Badge variant={'invalid' as any} data-testid="invalid-variant">Test</Badge>);
      }).not.toThrow();
    ...
    it('should handle invalid size gracefully', () => {
      expect(() => {
        render(<Badge size={'invalid' as any} data-testid="invalid-size">Test</Badge>);
      }).not.toThrow();
