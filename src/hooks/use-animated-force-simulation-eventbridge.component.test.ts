...
describe.skip("useAnimatedForceSimulation EventBridge Integration", () => {
  ...
  describe("EventBridge Communication", () => {
    ...
    it("should handle worker error via EventBridge", async () => {
      const onError = vi.fn();
      renderHook(() => useAnimatedForceSimulation({ onError }));
    ...
    it("should handle force simulation progress via EventBridge", async () => {
      ...
      const { result } = renderHook(() => useAnimatedForceSimulation({ onPositionUpdate }));
    ...
    it("should handle force simulation complete via EventBridge", async () => {
      ...
      const onPositionUpdate = vi.fn();
      const { result } = renderHook(() => useAnimatedForceSimulation({ onComplete, onPositionUpdate }));
