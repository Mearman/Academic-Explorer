...
const ErrorTestComponent: React.FC = () => {
	...
	if (shouldThrow) {
		throw new Error("Test error from ErrorTestComponent - This should be caught by GlobalErrorBoundary");
	}
	...
	const triggerJSError = () => {
		...
		setTimeout(() => {
			throw new Error("Test JavaScript error - This should be caught by global error handling");
		}, 100);
	};
	...
	return (
		<Container size="md" py="xl">
			<Stack gap="lg">
				...
				>
					<Text size="sm">
						This page is only available in development mode and is used to test error handling.
					</Text>
				</Alert>
				...
				<Alert color="blue" variant="light">
					<Text size="sm">
						...
						<br />
						• React Error: Should display the GlobalErrorBoundary UI with copy functionality
						<br />
						• Async/JS Errors: Should appear in console and Application Logger Panel
					</Text>
				</Alert>
			</Stack>
		</Container>
