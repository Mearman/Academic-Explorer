...
const ruleMessages = {
  ...
  functionCallDependency: 'Avoid function calls in hook dependencies. Compute values outside or use useMemo.',
  storeComputedFunction: 'Avoid store computed functions in hook dependencies. Use stable selectors instead.'
};
