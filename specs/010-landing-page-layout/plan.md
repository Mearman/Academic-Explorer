...
Improve the layout and responsive design of the BibGraph landing page (root route `/`) to ensure proper spacing, alignment, and visual hierarchy across all viewport sizes. Update E2E tests to verify layout correctness, touch target sizes, and responsive behavior.
