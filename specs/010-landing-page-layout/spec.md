...
A first-time visitor arrives at the Bibliom homepage and needs to immediately understand what the application offers and how to begin exploring academic literature.
...
1. **Given** a user visits the homepage, **When** the page loads, **Then** the title "Bibliom" is prominently displayed at the top
