...
This document defines the data structures, relationships, and validation rules for implementing complete OpenAlex relationship support in Bibliom. The model ensures type-safe, bidirectionally consistent graph edges that accurately represent academic network connections.
...
Complete enumeration of all relationship types supported in Bibliom.
