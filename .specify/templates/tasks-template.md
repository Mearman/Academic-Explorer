...
- [ ] T010 [P] [US1] Unit test for [endpoint] in tests/[name].unit.test.ts
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/[name].integration.test.ts
...
- [ ] T018 [P] [US2] Unit test for [endpoint] in tests/[name].unit.test.ts
- [ ] T019 [P] [US2] Integration test for [user journey] in tests/[name].integration.test.ts
...
- [ ] T024 [P] [US3] Unit test for [endpoint] in tests/[name].unit.test.ts
- [ ] T025 [P] [US3] Integration test for [user journey] in tests/[name].integration.test.ts
...
- [ ] TXXX [P] Additional unit tests (if requested) in tests/ (using *.unit.test.ts naming)
...
Task: "Unit test for [endpoint] in tests/[name].unit.test.ts"
Task: "Integration test for [user journey] in tests/[name].integration.test.ts"
